...
class PartsControllerTest < ActionController::TestCase
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post :create, part: { body: @part.body, order: @part.order, story_id: @part.story_id, title: @part.title }
    end
  ...
  test "should update part" do
    patch :update, id: @part, part: { body: @part.body, order: @part.order, story_id: @part.story_id, title: @part.title }
    assert_redirected_to part_path(assigns(:part))
  end
